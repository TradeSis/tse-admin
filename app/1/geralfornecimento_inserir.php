...
if (isset($LOG_CAMINHO)) {
    ...
    if (isset($LOG_NIVEL)) {
        if ($LOG_NIVEL >= 1) {
            $arquivo = fopen(defineCaminhoLog() . "admin_inserir" . date("dmY") . ".log", "a");
        }
    }
}
if (isset($LOG_NIVEL)) {
...
if (isset($jsonEntrada['Cnpj'])) {
    ...
    try {
        ...
        $retorno = $progr->executarprogress("admin/app/1/geralfornecimento_inserir",json_encode($jsonEntrada));
